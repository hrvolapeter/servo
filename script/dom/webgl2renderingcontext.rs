...
// DUMMY
struct HTMLCanvasElement<TH: TypeHolderTrait> {
    _p: PhantomData<TH>,
}
struct WebGLActiveInfo<TH: TypeHolderTrait> {
    _p: PhantomData<TH>,
}
struct WebGLBuffer<TH: TypeHolderTrait> {
    _p: PhantomData<TH>,
}
struct WebGLProgram<TH: TypeHolderTrait> {
    _p: PhantomData<TH>,
}
struct WebGLRenderbuffer<TH: TypeHolderTrait> {
    _p: PhantomData<TH>,
}
struct WebGLFramebuffer<TH: TypeHolderTrait> {
    _p: PhantomData<TH>,
}
struct HTMLIFrameElement<TH: TypeHolderTrait> {
    _p: PhantomData<TH>,
}
trait LayoutCanvasWebGLRenderingContextHelpers {
    unsafe fn canvas_data_source(&self) -> HTMLCanvasDataSource;
} 
struct WebGLRenderingContext<TH: TypeHolderTrait> {
    _p: PhantomData<TH>,
}
struct WebGLShader<TH: TypeHolderTrait> {
    _p: PhantomData<TH>,
}
struct WebGLShaderPrecisionFormat<TH: TypeHolderTrait> {
    _p: PhantomData<TH>,
}
struct WebGLTexture<TH: TypeHolderTrait> {
    _p: PhantomData<TH>,
}
struct WebGLUniformLocation<TH: TypeHolderTrait> {
    _p: PhantomData<TH>,
}
// DUMMY
...
impl<TH: TypeHolderTrait> WebGL2RenderingContext<TH> {
    ...
    pub fn base_context(&self) -> DomRoot<WebGLRenderingContext<TH>> {
...
impl<TH: TypeHolderTrait> WebGL2RenderingContextMethods<TH> for WebGL2RenderingContext<TH> {
    ...
    #[allow(unsafe_code)]
    /// https://www.khronos.org/registry/webgl/specs/latest/1.0/#5.14.9
    unsafe fn GetProgramParameter(&self, cx: *mut JSContext, program: &WebGLProgram<TH>, param_id: u32) -> JSVal {
    ...
    #[allow(unsafe_code)]
    /// https://www.khronos.org/registry/webgl/specs/latest/1.0/#5.14.9
    unsafe fn GetShaderParameter(&self, cx: *mut JSContext, shader: &WebGLShader<TH>, param_id: u32) -> JSVal {
    ...
    fn FramebufferTexture2D(&self, target: u32, attachment: u32,
                            textarget: u32, texture: Option<&WebGLTexture<TH>>,
                            level: i32) {
