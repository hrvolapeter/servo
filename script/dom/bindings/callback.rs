...
use dom::bindings::error::{report_pending_exception, Error, Fallible};
...
use js::jsapi::{AddRawValueRoot, IsCallable, JSContext, JSObject, JS_WrapObject};
...
pub fn wrap_call_this_object<T: DomObject>(cx: *mut JSContext, p: &T, rval: MutableHandleObject) {
...
impl<TH: TypeHolderTrait> CallSetup<TH> {
    ...
    #[allow(unrooted_must_root)]
    pub fn new<T: CallbackContainer<TH>>(callback: &T, handling: ExceptionHandling) -> CallSetup<TH> {
