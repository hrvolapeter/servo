...
pub struct DOMClass {
    ...
    /// TODO: The MallocSizeOf function wrapper for that interface.
...
pub unsafe extern "C" fn enumerate_global<TH: TypeHolderTrait>(cx: *mut JSContext, obj: HandleObject) -> bool {
